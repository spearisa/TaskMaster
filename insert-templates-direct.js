// Direct database insertion script for productivity templates
import pg from 'pg';
const { Pool } = pg;
...
// List of 30 productivity template ideas with descriptions
const productivityTemplates = [
  // Daily/Weekly Planning
  {
    ...
    category: "personal",
    priority: "high",
    steps: ["Track your current morning habits for 3 days", "Identify energy-draining and energy-boosting activities", "Design an ideal morning sequence (30-90 minutes)", "Prepare your environment the night before", "Test your routine for one week and adjust as needed"],
    tags: ["routine", "morning", "productivity", "habits"],
    is_public: true,
    user_id: 1,
    estimated_time: 30
  },
  {
    ...
    category: "work",
    priority: "high",
    steps: ["Review previous week's accomplishments and incomplete tasks", "Identify your top 3 priorities for the coming week", "Schedule focused work blocks for important projects", "Plan buffer time for unexpected tasks", "Schedule personal commitments and self-care activities", "Prepare your workspace and tools for Monday"],
    tags: ["planning", "weekly review", "time management", "productivity"],
    is_public: true,
    user_id: 1,
    estimated_time: 45
  },
  {
    ...
    category: "personal", 
    priority: "medium",
    steps: ["Record 3 achievements from today (big or small)", "Note any challenges or roadblocks encountered", "Identify one thing you learned today", "List the top 3 priorities for tomorrow", "Write one thing you are grateful for"],
    tags: ["reflection", "journaling", "productivity", "habits"],
    is_public: true,
    user_id: 1,
    estimated_time: 15
  },
  {
    ...
    category: "personal",
    priority: "medium",
    steps: ["Set a consistent cutoff time for work and screens", "Create a quick cleanup routine for your living space", "Review tomorrow's calendar and prepare any materials", "Choose a relaxing activity (reading, stretching, meditation)", "Establish a consistent bedtime ritual"],
    tags: ["evening routine", "sleep", "relaxation", "productivity"],
    is_public: true,
    user_id: 1,
    estimated_time: 60
  },
  {
    ...
    category: "personal",
    priority: "high",
    steps: ["Quick home reset (30-minute tidying and cleaning)", "Review and update your calendar for the week", "Meal plan and grocery shop for the week ahead", "Set 3 personal and 3 professional goals for the week", "Prepare your workspace and materials", "Schedule self-care and personal commitments"],
    tags: ["planning", "weekly reset", "organization", "productivity"],
    is_public: true,
    user_id: 1,
    estimated_time: 120
  },
  {
    ...
    category: "personal",
    priority: "medium",
    steps: ["Find a quiet moment at the start of your day", "Review your calendar and commitments", "Identify your 3 most important tasks (MITs)", "Set a positive intention or theme for the day", "Visualize successfully completing your priorities"],
    tags: ["mindfulness", "planning", "productivity", "focus"],
    is_public: true,
    user_id: 1,
    estimated_time: 10
  },
  {
    ...
    category: "work",
    priority: "high",
    steps: ["List all your recurring commitments and meetings", "Identify your peak energy periods during the day", "Schedule focused deep work during high-energy times", "Block time for email/communication in batches", "Include breaks and transitions between blocks", "Set aside planning and review blocks"],
    tags: ["time management", "scheduling", "focus", "productivity"],
    is_public: true,
    user_id: 1,
    estimated_time: 30
  },
  {
    ...
    category: "work", 
    priority: "high",
    steps: ["Clear your workspace and gather necessary materials", "Review and process all notes, emails, and tasks", "Evaluate progress on projects and goals", "Identify what went well and areas for improvement", "Update your project plans and task lists", "Set key priorities and intentions for the coming week"],
    tags: ["review", "planning", "reflection", "productivity"],
    is_public: true,
    user_id: 1,
    estimated_time: 60
  },
  {
    ...
    category: "personal",
    priority: "medium",
    steps: ["Choose a consistent time each day (morning or evening)", "Find a quiet space with minimal distractions", "Write down 3-5 things you are grateful for today", "Include at least one work-related gratitude", "Be specific about why each item matters to you"],
    tags: ["gratitude", "mindfulness", "wellbeing", "habits"],
    is_public: true,
    user_id: 1,
    estimated_time: 5
  },
  {
    ...
    category: "personal",
    priority: "medium",
    steps: ["Select 1-3 specific habits you want to establish", "Create a tracking grid with 30 days and your habits", "Define what counts as success for each habit", "Set a consistent time to check off your progress daily", "Add visual rewards or milestones every 7 days", "Review and adjust your system weekly"],
    tags: ["habits", "tracking", "consistency", "personal development"],
    is_public: true,
    user_id: 1,
    estimated_time: 15
  ...
  // Work Productivity
  {
    ...
    category: "work",
    priority: "high",
    steps: ["Define the meeting purpose and desired outcomes", "List specific agenda topics with time allocations", "Assign roles (facilitator, timekeeper, note-taker)", "Distribute agenda and pre-work 24+ hours in advance", "Include start/end times and required preparation", "End with clear action items, owners, and deadlines"],
    tags: ["meetings", "collaboration", "communication", "leadership"],
    is_public: true,
    user_id: 1,
    estimated_time: 20
  },
  {
    ...
    category: "work",
    priority: "high",
    steps: ["Define project scope, objectives, and success metrics", "Identify key stakeholders and their expectations", "Create a responsibility matrix (RACI chart)", "Establish communication protocols and meeting cadence", "Set up project management tools and workspaces", "Develop initial timeline with major milestones", "Identify potential risks and mitigation strategies"],
    tags: ["project management", "planning", "teamwork", "organization"],
    is_public: true,
    user_id: 1,
    estimated_time: 90
  },
  {
    ...
    category: "work",
    priority: "medium",
    steps: ["Set up folder structure (Action, Waiting, Archive, Reference)", "Establish specific times for checking email (e.g., 10am, 2pm, 5pm)", "Process inbox using the 2-minute rule (do it now if quick)", "Create templates for common responses", "Unsubscribe from low-value newsletters", "Configure filters and rules for automatic organization"],
    tags: ["email", "digital organization", "communication", "focus"],
    is_public: true,
    user_id: 1,
    estimated_time: 60
  },
  {
    ...
    category: "work",
    priority: "high",
    steps: ["Identify a single, important task that requires deep focus", "Set a clear, achievable objective for the session", "Eliminate all potential distractions (notifications, phone, etc.)", "Set a timer for 25-90 minutes depending on your capacity", "Work exclusively on the chosen task until the timer ends", "Take a 5-15 minute break before starting another session"],
    tags: ["focus", "deep work", "productivity", "time management"],
    is_public: true,
    user_id: 1,
    estimated_time: 90
  },
  {
    ...
    category: "work",
    priority: "high",
    steps: ["List all current tasks and commitments", "Create a 2x2 matrix (Urgent/Not Urgent, Important/Not Important)", "Place each task in the appropriate quadrant", "Schedule important but not urgent tasks (Quadrant 2) first", "Address urgent and important tasks (Quadrant 1) next", "Delegate or batch urgent but not important tasks (Quadrant 3)", "Eliminate or minimize not urgent and not important tasks (Quadrant 4)"],
    tags: ["prioritization", "time management", "decision making", "productivity"],
    is_public: true,
    user_id: 1,
    estimated_time: 25
  ...
  // Personal Development
  {
    ...
    category: "personal",
    priority: "medium",
    steps: ["Identify 3-5 key life domains to track (career, health, relationships, etc.)", "Define specific metrics or indicators for each domain", "Create a simple tracking system (spreadsheet, journal, or app)", "Schedule weekly check-ins to record progress", "Implement monthly reviews to identify patterns", "Set quarterly milestones to celebrate progress", "Adjust goals and metrics as needed"],
    tags: ["personal development", "tracking", "goals", "self-improvement"],
    is_public: true,
    user_id: 1,
    estimated_time: 60
  },
  {
    ...
    category: "personal",
    priority: "high",
    steps: ["Reflect on personal values and priorities", "Create a vision statement for 1, 3, and 10 years ahead", "Identify goals in key life domains (career, health, relationships, etc.)", "Format goals using the SMART framework (Specific, Measurable, Achievable, Relevant, Time-bound)", "Break down each goal into milestone achievements", "Identify potential obstacles and mitigation strategies", "Develop a regular review and adjustment system"],
    tags: ["goal setting", "planning", "personal development", "motivation"],
    is_public: true,
    user_id: 1,
    estimated_time: 180
  },
  {
    ...
    category: "education",
    priority: "medium",
    steps: ["Define the specific skill you want to acquire", "Research the components and sub-skills involved", "Find high-quality learning resources (courses, books, mentors)", "Break down the skill into practice elements", "Create a progressive practice schedule (start easy, increase difficulty)", "Establish feedback mechanisms to assess progress", "Schedule regular review and adjustment of your approach"],
    tags: ["learning", "skill development", "practice", "education"],
    is_public: true,
    user_id: 1,
    estimated_time: 90
  ...
  // Health & Wellness
  {
    ...
    category: "health",
    priority: "high",
    steps: ["Define your primary fitness goals (strength, endurance, flexibility, etc.)", "Assess your current fitness level and limitations", "Determine available equipment and workout environment", "Select appropriate exercises for each muscle group/fitness component", "Structure a weekly schedule with appropriate intensity and recovery", "Create a progression plan for increasing challenge over time", "Schedule regular assessment points to track progress"],
    tags: ["fitness", "health", "exercise", "wellness"],
    is_public: true,
    user_id: 1,
    estimated_time: 90
  },
  {
    ...
    category: "health",
    priority: "medium",
    steps: ["Review your schedule for the coming week", "Check your pantry and refrigerator inventory", "Create a balanced meal plan considering nutritional needs", "Develop a consolidated shopping list organized by store section", "Schedule batch cooking sessions if applicable", "Prepare meal components in advance as needed", "Implement a system for using or repurposing leftovers"],
    tags: ["nutrition", "meal prep", "health", "planning"],
    is_public: true,
    user_id: 1,
    estimated_time: 60
  },
  {
    ...
    category: "health",
    priority: "high",
    steps: ["Assess current sleep patterns and challenges", "Optimize your sleep environment (temperature, light, sound)", "Develop a consistent pre-sleep routine (30-60 minutes)", "Establish regular sleep and wake times", "Adjust daytime habits that affect sleep (caffeine, exercise, etc.)", "Create a plan for managing sleep disruptors", "Track sleep quality and adjust approach as needed"],
    tags: ["sleep", "health", "wellness", "habits"],
    is_public: true,
    user_id: 1,
    estimated_time: 90
  ...
  // Project Management
  {
    ...
    category: "work",
    priority: "high",
    steps: ["Define the project scope, objectives, and success criteria", "Identify key stakeholders and their requirements", "Break the project into phases and major deliverables", "Create a work breakdown structure (WBS)", "Estimate resource requirements and availability", "Develop a realistic timeline with dependencies", "Identify potential risks and mitigation strategies", "Establish communication and reporting protocols"],
    tags: ["project management", "planning", "organization", "teamwork"],
    is_public: true,
    user_id: 1,
    estimated_time: 180
  ...
  // Travel & Events
  {
    ...
    category: "travel",
    priority: "medium",
    steps: ["Establish trip objectives, dates, and budget", "Research and book transportation and accommodations", "Create a day-by-day itinerary with flexibility built in", "Make a packing list categorized by type", "Prepare home for your absence (mail, plants, security)", "Gather and organize travel documents", "Set up phone/tech for international use if applicable", "Research local customs, phrases, and safety information"],
    tags: ["travel", "planning", "organization", "checklist"],
    is_public: true,
    user_id: 1,
    estimated_time: 120
  ...
  // Digital Productivity
  {
    ...
    category: "general",
    priority: "high",
    steps: ["Choose a reputable password manager application", "Set up your master password and recovery options", "Import existing passwords from browsers/other sources", "Audit and update weak or duplicate passwords", "Create strong, unique passwords for important accounts", "Organize passwords into logical categories", "Set up two-factor authentication where available", "Establish a regular password review schedule"],
    tags: ["security", "digital organization", "passwords", "technology"],
    is_public: true,
    user_id: 1,
    estimated_time: 90
  ...
  // Finance & Budget
  {
    ...
    category: "finance",
    priority: "high",
    steps: ["Gather all financial statements and records", "Compare actual spending to budgeted categories", "Identify unexpected expenses or variances", "Review progress toward savings and debt reduction goals", "Adjust upcoming month's budget based on insights", "Update financial tracking tools and dashboards"],
    tags: ["budgeting", "finance", "money management", "planning"],
    is_public: true,
    user_id: 1,
    estimated_time: 60
  },
  {
    ...
    category: "finance",
    priority: "high",
    steps: ["Choose a tracking method (app, spreadsheet, or journal)", "Define relevant spending categories for your lifestyle", "Set up automatic import from financial accounts if possible", "Establish a daily routine for logging cash expenses", "Create weekly review checkpoint", "Set up visualization tools for spending patterns"],
    tags: ["finance", "tracking", "budgeting", "money management"],
    is_public: true,
    user_id: 1,
    estimated_time: 45
  },
  {
    ...
    category: "finance",
    priority: "high",
    steps: ["Identify financial goals across different time horizons", "Prioritize goals based on importance and timing", "Research the costs and requirements for each goal", "Create specific, measurable targets with deadlines", "Develop action plans with savings and investment strategies", "Set up automated systems for goal funding", "Establish quarterly review checkpoints"],
    tags: ["financial planning", "goals", "saving", "investing"],
    is_public: true,
    user_id: 1,
    estimated_time: 120
  ...
  // Home Management
  {
    ...
    category: "home",
    priority: "medium",
    steps: ["List all cleaning tasks needed for your home", "Categorize by frequency (daily, weekly, monthly, seasonal)", "Assign tasks to specific days of the week", "Create cleaning checklists for each room", "Set up a supply management system", "Implement 15-minute daily maintenance sessions", "Schedule quarterly deep cleaning projects"],
    tags: ["cleaning", "home management", "organization", "routines"],
    is_public: true,
    user_id: 1,
    estimated_time: 40
  },
  {
    ...
    category: "home",
    priority: "medium",
    steps: ["Define your decluttering goals and priorities", "Break your space into manageable zones", "Create a schedule for tackling one zone at a time", "Sort items using the four-box method (keep, donate, sell, trash)", "Establish clear criteria for keeping items", "Process discarded items promptly", "Implement systems to prevent future clutter"],
    tags: ["decluttering", "organization", "minimalism", "home management"],
    is_public: true,
    user_id: 1,
    estimated_time: 30
  },
  {
    ...
    category: "home",
    priority: "high",
    steps: ["Identify potential emergency scenarios for your region", "Create a household communication plan", "Assemble emergency kits for home and vehicles", "Document important information and contacts", "Develop evacuation routes and meeting locations", "Store copies of critical documents securely", "Schedule regular drills and supply refreshment"],
    tags: ["emergency planning", "safety", "preparation", "home management"],
    is_public: true,
    user_id: 1,
    estimated_time: 180
